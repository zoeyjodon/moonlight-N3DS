...
LIBS	:= -lswresample -lavformat -lswscale -lavcodec -lavutil -lcitro2d -lcitro3d -lfreetype -lpng -lbz2 -lopus -lexpat -lm -lcurl -lcrypto -lmbedtls -lmbedx509 -lmbedcrypto -lz -lctru
